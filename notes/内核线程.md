...
其中pgdir_vaddr 为用户进程专有，内核线程置为NULL，其保存了进程页目录表在内核空间的地址。
...
void initThread(void)
{
	...
	list_init(&thread_all_list);	    //初始化全部PCB节点队列
	make_main_thread();				   //在0xc0009e00创建主线程PCB
...
static void make_main_thread(void)
{
	...
	main_thread->self_kernel_stack = 0xc009f000;   //设置主线程栈esp
