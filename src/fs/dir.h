...
/*在内存中设置 目录条目*/
extern void init_dir_entry(struct dir_entry*p_de,char*filename,uint32_t inode_no,enum file_type ft,char*part_name);
/*用名查询目录条目*/
...
//将dir_entry同步到磁盘
extern bool sync_dir_entry(struct dir* parent_dir,struct dir_entry* d_entry,struct partition*part);
//从目录中删除dir_entry
...
extern bool remove_empty_dir(struct dir*parent_dir,struct dir*dir);
#endif